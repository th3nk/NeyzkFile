...
redis:setex(neyzk..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_,500,true)
...
if msg.text and msg.type ~= "pv" and redis:get(neyzk..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_) then
redis:del(neyzk..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_)
