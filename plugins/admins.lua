...
local function neyzk_send(chat_id, reply_to_message_id, text) local TextParseMode = {ID = "TextParseModeMarkdown"}
...
neyzk_send(chat,msg.id_,"*📮¦ انا لست ادمن هنا يرجى ترقيتي وتفعيل جميع الصلاحيات \n👨🏻‍✈️*")   
return false end      
tdcli_function ({ID = "GetChatMember",chat_id_ = chat,user_id_ = user},function(arg,da) 
tdcli_function ({ID = "GetUser",user_id_ = user},function(arg,data) 
if data.message_ == "User not found" then
neyzk_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ لا استطيع استخراج معلوماته ✨ *\n', 1, 'md')
return false  end
if tonumber(user) == tonumber(neyzk) then  
neyzk_send(chat,msg.id_,"*📮¦ انا بوت لا تستطيع تنزيلي \n👨🏻‍✈️*")   
return false  end 
if (da and da.status_.ID == "ChatMemberStatusCreator") then
neyzk_send(chat,msg.id_,"*📮¦ عذرآ هاذا الشخص هوا منشئ المجموعه \n👨🏻‍✈️*")   
return false  end 
if (da and da.status_.ID == "ChatMemberStatusMember") then
neyzk_send(chat,msg.id_,"*📮¦ عذرآ هاذا الشخص ليس ادمن في المجموعه \n👨🏻‍✈️*")   
return false  end 
...
neyzk_send(chat,msg.id_,"*📮¦ عذرآ هناك خطأ يرجي تفعيل صلاحية { اضافة مشرفين جدد } حتى استطيع تنزيله \n👨🏻‍✈️*")   
return false  end 
if (JSON_ADMIN.description == "Bad Request: CHAT_ADMIN_REQUIRED" and JSON_ADMIN.error_code == 400) then
neyzk_send(chat,msg.id_,"*📮¦ عذرآ هناك خطأ المستخدم انا لم اقم بترقيته مشرف في المجموعه لا استطيع تنزيله \n👨🏻‍✈️*")   
return false  end 
...
if redis:get(neyzk.."Add:Pin"..msg.chat_id_) then
pin_msg = 'true'
pin = 'ꪜ'
else
pin_msg = 'false'
...
if redis:get(neyzk.."Add:Kick"..msg.chat_id_) then
Add_Kick = 'true'
kick = 'ꪜ'
else
Add_Kick = 'false'
...
if redis:get(neyzk.."Add:Info"..msg.chat_id_) then
Add_Info = 'true'
info = 'ꪜ'
else
Add_Info = 'false'
...
if redis:get(neyzk.."Add:Set:Admin"..msg.chat_id_) then
Add_SetAdmin = 'true'
adde = 'ꪜ'
else
Add_SetAdmin = 'false'
...
if redis:get(neyzk.."Add:Del"..msg.chat_id_) then
Add_Del = 'true'
del = 'ꪜ'
else
Add_Del = 'false'
...
neyzk_send(chat,msg.id_,"*📮¦ انا بوت وصلاحيتي هي الادمن \n👨🏻‍✈️*")   
return false  end 
if (da and da.status_.ID == "ChatMemberStatusCreator") then
neyzk_send(chat,msg.id_,"*📮¦ عذرآ هاذا الشخص هوا منشئ المجموعه \n👨🏻‍✈️*")   
return false  end 
if (da and da.status_.ID == "ChatMemberStatusEditor") then
neyzk_send(chat,msg.id_,"*📮¦ عذرآ هاذا الشخص هوا ادمن في المجموعه \n👨🏻‍✈️*")   
return false  end 
...
local JSON_ADMIN = JSON.decode(SET_ADMIN)
if (JSON_ADMIN.description == "Bad Request: not enough rights" and JSON_ADMIN.error_code == 400) then
neyzk_send(chat,msg.id_,"*📮¦ عذرآ هناك خطأ يرجي تفعيل صلاحية { اضافة مشرفين جدد } حتى استطيع ترقيته \n👨🏻‍✈️*")   
return false  end 
if (JSON_ADMIN.result == true) then
...
neyzk_send(msg.chat_id_,msg.id_,'*\n🚸¦ صلاحياته منشئ الكروب 🍃*')   
return false  end 
...
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
...
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ المعرف غير صحيح \n👨🏻‍✈️*")   
return false  end   
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ هاذا معرف قناة \n👨🏻‍✈️*")   
return false end      
...
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. neyzk..'')
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.ok == true then
if Json_Info.result.status == "administrator" then
if Json_Info.result.can_change_info == true then
...
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(neyzk.."Add:Pin"..msg.chat_id_,true)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تفعيل صلاحيه التثبيت')
end
if MsgText[1] == "تعطيل" and MsgText[2] == "صلاحيه التثبيت" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(neyzk.."Add:Pin"..msg.chat_id_)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تعطيل صلاحيه التثبيت')
end
if MsgText[1] == "تفعيل" and MsgText[2] == "صلاحيه الحذف" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(neyzk.."Add:Del"..msg.chat_id_,true)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تفعيل صلاحيه حذف الرسائل')
end
if MsgText[1] == "تفعيل" and MsgText[2] == "صلاحيه الحذف" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(neyzk.."Add:Del"..msg.chat_id_)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تعطيل صلاحية حذف الرسائل')
end
if MsgText[1] == "تفعيل" and MsgText[2] == "صلاحيه الرفع" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(neyzk.."Add:Set:Admin"..msg.chat_id_,true)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تفعيل صلاحيه اضافه مشرفين جدد')
end
if MsgText[1] == "تعطيل" and MsgText[2] == "صلاحيه الرفع" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(neyzk.."Add:Set:Admin"..msg.chat_id_)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تعطيل صلاحيه اضافة مشرفين جدد')
end
if MsgText[1] == "تفعيل" and MsgText[2] == "صلاحيه المعلومات" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(neyzk.."Add:Info"..msg.chat_id_,true)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تفعيل صلاحيه تغير معلومات المجموعه')
end
if MsgText[1] == "تعطيل" and MsgText[2] == "صلاحيه المعلومات" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(neyzk.."Add:Info"..msg.chat_id_)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تعطيل صلاحيه تغير معلومات المجموعه')
end
if MsgText[1] == "تفعيل" and MsgText[2] == "صلاحيه الطرد" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:set(neyzk.."Add:Kick"..msg.chat_id_,true)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تفعيل صلاحيه طرد المستخدمين')
end
if MsgText[1] == "تعطيل" and MsgText[2] == "صلاحيه الطرد" then 
if not msg.Creator then
neyzk_send(msg.chat_id_,msg.id_,"*📮¦ عذرآ لا تستطيع استخدام هاذا الامر \n👨🏻‍✈️*")   
return false  end 
redis:del(neyzk.."Add:Kick"..msg.chat_id_)   
neyzk_send(msg.chat_id_,msg.id_,'🔰| تم تعطيل صلاحيه طرد المستخدمين')
end
...
neyzk_send(msg.chat_id_,msg.id_,textt)   
end
